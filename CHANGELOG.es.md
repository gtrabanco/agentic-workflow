...
| `review-implementation` | 1.2.1 | 2026-07-19 | parche | Aclara el alcance de las comprobaciones de anulación hacia fix-now: solo condicionan `postpone`/`intentional-tradeoff` para un *defecto real confirmado* — `ignore` (falso positivo/negligible) se decide antes y nunca debió pasar por esta puerta. Solo redacción; sin cambio de comportamiento. |
...
- **2026-07-19 — comprobaciones de anulación hacia fix-now + reconstrucción de blockers en fold-findings.**
  ...
  para un defecto real confirmado, nunca `ignore`.
