...
| Versión | Fecha | Tipo | Qué cambió |
|---|---|---|---|
| 0.9.2 | 2026-09-12 | patch | **re-bundle de skills de la feature 37 (fold F25–F26 + P4)**: publica las skills empaquetadas desde 0.9.1 — la valla de pegado del linter (`execute-phase` 4.5.1, `plan-fix` 3.2.1, `plan-feature-scaffold` 2.3.1) y el texto de entrega del linter determinista de la P4 (`execute-phase` 4.5.0, `plan-fix` 3.2.0, `plan-feature-scaffold` 2.3.0), que se reflejó en el paquete pero nunca se publicó. Sin cambios de código del paquete — el bump existe para publicar el re-empaquetado. |
