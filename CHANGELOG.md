...
| `pre-execution-review` | 2.3.0 | 2026-09-18 | minor | **Fifth gate-rejection type (feature 60 P3):** `POLICY.md` §8's closed gate-rejection vocabulary gains `path-protection` (printed by `execute-phase`'s preflight) and the prose counts five, so the block and the sentence stay consistent. |
