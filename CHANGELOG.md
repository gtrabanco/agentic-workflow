...
- **2026-07-19 — fix-now override checks + fold-findings blocker reconstruction.**
  ...
  SPEC, same branch) instead of being downgraded. `review-change` 2.5.0
