...
| Version | Date | Type | What changed |
|---|---|---|---|
| 0.9.2 | 2026-09-12 | patch | **feature 37 skill re-bundle (F25–F26 fold + P4)**: publishes the skills bundled since 0.9.1 — the phase-lint paste fence (`execute-phase` 4.5.1, `plan-fix` 3.2.1, `plan-feature-scaffold` 2.3.1) and the P4 deterministic-linter hand-off wording (`execute-phase` 4.5.0, `plan-fix` 3.2.0, `plan-feature-scaffold` 2.3.0), which was mirrored into the package but never published. No package code change — the bump exists to publish the re-bundle. |
