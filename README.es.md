...
| `plan-fix`     | El equivalente del flujo de fix: como arquitecto redacta un SPEC de fix acotado a partir de un issue — siempre con un ledger `## Phases` (≥ 2 fases, la última = `Hardening & PR`) — commitea en una rama de fix y **se detiene para revisión**.                                                                                                                                                                                                                                                                                                                                                           |
