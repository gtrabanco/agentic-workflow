...
| F17 | opencode.jsonc:7-29; .pi/mcp.json:4-23 | security | medium | fix-now | fold into branch | no |
| F18 | scripts/check-skill-context.mjs:23-42 | code | major | fix-now | fold into branch | no |
