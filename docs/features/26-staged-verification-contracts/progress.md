...
- Commit: pending (bound by the P20 fold) · Gate: `cd packages/agentic-workflow-schema && npm run gate:verification` (exit 0: 554/554 tests, projections drift-free, package content PASS, docs 24/24, p95 31.87 ms ≤ 100 ms) · Acceptance blob: 2e8058860b2c805cc30507053f15f91e2f273249
