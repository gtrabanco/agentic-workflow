...
- Commit: pending · Gate: `cd packages/agentic-workflow-schema && npm run gate:verification` (exit 0: 484/484 tests, projections drift-free, package content PASS, docs 23/23, p95 20.42 ms ≤ 100 ms) · Acceptance blob: 2e8058860b2c805cc30507053f15f91e2f273249
