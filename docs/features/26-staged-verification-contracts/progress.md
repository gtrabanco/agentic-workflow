...
- Every validator below is the literal command from the frozen manifest, run against this candidate. **554 package tests / 0 fail**, of which the feature-26 verification suites are 321 cases across 13 files plus 24 docs cases.
