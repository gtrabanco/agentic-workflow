# PLAN — 28-evidence-grounded-spec-plan-review

Five implementation phases. Product authority, contract shapes, review
vocabulary, repair ownership, compatibility, and runtime boundaries are frozen
in `SPEC.md`; exact tasks and validators live in `TASKS.md` and
`ACCEPTANCE.md`.

## P1 — Publish pre-execution evidence contracts

Layer: schema/db · add the authoritative bounded snapshot/receipt family,
