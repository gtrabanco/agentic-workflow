...
| F30 | scripts/pre-execution-snapshot.mjs:111 | code | low | fix-now | fold (delete the unreferenced `ATTRIBUTION_ORDER` table and correct the comment that claims it is load-bearing) | no |
