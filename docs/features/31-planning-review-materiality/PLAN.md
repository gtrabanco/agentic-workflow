...
and `decisions.md` (E-D31-1…E-D31-7). Artifact revision of this plan set:
**`31-plan-2`** (repair batch, 2026-09-17, for `plan-review-31-1`'s findings
F01/F02/F03 — see SPEC `## Amendments`); the first scaffold write was `31-plan-1`
(2026-09-17, from the Product half at artifact revision `31-spec-1`, receipt
`spec-review-31-1` @ snapshot
...
`d85e217acad1322d3caf4968715ef5d00e9189c0` (the scaffold-time blob was
`f220c1dd432125a9524dd37d7286202d58d8a731`; the repair batch re-froze it) —
re-verified at first execution run.
