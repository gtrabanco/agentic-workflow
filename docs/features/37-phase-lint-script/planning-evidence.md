...
§ "Plan-stage table — one declared extension"). Artifact revision: `37-plan-3`.
...
|---|---|---|---|---|---|---|---|---|
| PE-001 | The eight phase-lint rules, the fixed PASS/BLOCKED result, and the fingerprint format `P<n>:<layer>:<n-tasks>:<title-deliverable>` are owned by `phase-contract`; from P1 of this PR the owner will be v1.0.2 with the sanctioned rule-1 `Hardening & PR` exception; the linter implements checking, never invents rule semantics | repository | `skills/phase-contract/SKILL.md` §The eight phase-lint rules, §Normalized phase fingerprint; decisions.md ED6 | version 1.0.2 (after P1) | O1–O8, O-AC5 | current | proven | — |
