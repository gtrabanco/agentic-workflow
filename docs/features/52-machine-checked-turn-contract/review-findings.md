...
F5 | packages/agentic-workflow/bin/turn-contract.mjs:89 + template/.agentic-workflow/hooks/turn-contract.sh:57 | code | med | fix-now | fold | no
F6 | template/.agentic-workflow/hooks/turn-contract.sh:91 | perf | med | fix-now | fold | no
F7 | skills/orchestration-envelope/references/TURN_CONTRACT.md:23-36 (+ byte-identical pi-package mirror) | brand | med | fix-now | fold | no
