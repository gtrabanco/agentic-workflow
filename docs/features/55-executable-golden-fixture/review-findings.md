...
| F2 | scripts/golden-fixture.test.mjs:204-215 | code | med | fix-now | fold (source) · fold 9547f97 | yes |
...
| F3 | docs/workflow/GOLDEN_FIXTURE.md:22-25 | code | med | fix-now | fold (source) · fold 9547f97 | yes |
...
| F4 | docs/features/55-executable-golden-fixture/progress.md:204 | Upstream lineage | high | fix-now | replan (authority) · /review-plan 55 | no |
| F5 | docs/features/55-executable-golden-fixture/SPEC.md:615-628 | Obligation closure | high | fix-now | fold (source) · fold d0623bd | yes |

<!-- F4–F5 appended 2026-09-17 by `/audit-pr` (BLOCKED blocker persist, Process step 6) at HEAD f5337cd2738646d074cd7d01fe234bfb51546807 (PR #240). F4 names the plan-stage pre-execution receipt whose digest no longer re-derives identically (`stale-context`: CLAUDE.md moved at 87d5b2db); F5 names the unit's embedded obligation ledger still reading `planned` for O1–O14. -->
