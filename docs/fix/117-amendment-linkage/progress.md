## P1 — 2026-08-02
- Done: Closed GitHub issue #117 via `gh issue close 117`
- Remains: P2 — Hardening & PR (push, PR, link)
- Gotchas: none
- Files: docs/fix/117-amendment-linkage/SPEC.md, docs/fix/117-amendment-linkage/progress.md
