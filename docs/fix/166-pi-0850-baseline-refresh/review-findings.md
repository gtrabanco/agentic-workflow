...
|---|---|---|---|---|---|---|
| F1 | docs/fix/166-pi-0850-baseline-refresh/progress.md:31-36 + docs/fix/166-pi-0850-baseline-refresh/pr-body.md:40 | spec-drift | med | fix-now | fold (source) | yes · fold c95ff5b4 |
...
RESOLUTION 2026-09-06 — F1: FOLDED. The system pi runtime is 0.85.1; the three interactive smoke observations (routed set/clear, settings console round-trip, first-run hint) were re-executed on that runtime and pass, all six `- SMOKE` rows now carry real `outcome: pass` markers, and `pr-body.md`'s overclaim was corrected to the measured evidence.
