...
|---|---|---|---|---|---|---|
| F1 | docs/fix/166-pi-0850-baseline-refresh/progress.md:31-36 + docs/fix/166-pi-0850-baseline-refresh/pr-body.md:40 | spec-drift | med | fix-now | fold (source) | yes · fold <pending> |
