...
| F2 | skills/audit-pr/SKILL.md:107,114 | correctness | med | fix-now | fold-findings | no |
| F3 | skills/audit-pr/SKILL.md:251,258,272 | output-contract | med | fix-now | fold-findings | no |
| F4 | skills/audit-pr/SKILL.md:8 | parity | med | fix-now | fold-findings | no |
