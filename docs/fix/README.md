...
| [#166](https://github.com/gtrabanco/agentic-workflow/issues/166) | pi-0850-baseline-refresh | `pending` | Re-verify `@gtrabanco/pi-agentic-workflow` against pi 0.85.0 (dev peer re-point + suite + manual smoke) and refresh the verified-baseline note EN+ES; release bookkeeping 0.4.1 in the same PR. |
