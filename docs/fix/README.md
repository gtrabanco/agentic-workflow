...
| ------ | ----- | ------ | ---------- | ----- |
| `157-claude-skills-self-mount` | Untrack the always-on `.claude/skills` self-mount, gitignore local opt-in mounts, document the installed-release dogfooding model (CLAUDE.md + README EN/ES + local agent memory) | done · [#158](https://github.com/gtrabanco/agentic-workflow/pull/158) | — | [#157](https://github.com/gtrabanco/agentic-workflow/issues/157) |
