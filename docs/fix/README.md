...
| `119-progressive-planning-docs-adapters` | Restore NRS gating for issue-derived planning and the Docusaurus adapter contract | in progress | — | [#119](https://github.com/gtrabanco/agentic-workflow/issues/119) |
