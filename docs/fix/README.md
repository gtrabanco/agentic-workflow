...
| ------ | ----- | ------ | ---------- | ----- |
| `147-audit-evidence-provenance` | Fixed evidence-provenance gate + cross-audit delta checks for `product-audit` (forge authority, command-scope binding, inventory recompute, fixture traps T1–T4) | done | — | [#147](https://github.com/gtrabanco/agentic-workflow/issues/147) |
