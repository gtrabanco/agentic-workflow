...
| `117-amendment-linkage` | Close issue #117 — user-approved descope of P8 adversarial review (amendment linkage reference) | pending | — | [#117](https://github.com/gtrabanco/agentic-workflow/issues/117) |
