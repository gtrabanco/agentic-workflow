...
configurado → API key inválida). Ambas patas quedan abiertas como ítems manuales;
ninguna se declara satisfecha aquí. Las versiones intermedias plegadas dentro del
