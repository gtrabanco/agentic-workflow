...
Nota de cobertura (feature 28, P6, 2026-09-01): estas dos filas más la fila de
2026-08-31 cubren cada skill de ruta de ejecución que esta unidad cambió, en su
texto actual — review-spec 1.1.0 (fila de 2026-08-31), review-plan 1.1.0,
pre-execution-review 1.2.0, plan-fix 3.0.1, execute-phase 4.0.2, workflow-status
3.0.3, audit-pr 5.0.2. Las versiones intermedias plegadas dentro del ciclo sin
publicar de la unidad (workflow-status 3.0.0–3.0.2, execute-phase 4.0.1, audit-pr
5.0.0/5.0.1, plan-fix 3.0.0) nunca se publicaron por separado — la publicación en
