...
ejecutor más débil en la etapa de **Producto** la lleva ya una fila fechada
`nan/qwen3.6` más arriba (objetivo PASS, procedimiento FAIL — la ejecución escribió
en el repositorio anfitrión, hallazgo F35, revertido); la pata del revisor de
**Plan** en el ejecutor más débil y `evidence-grounding 1.2.0` siguen abiertas como
ítems manuales; ninguna se declara satisfecha aquí. Las versiones intermedias plegadas dentro del
