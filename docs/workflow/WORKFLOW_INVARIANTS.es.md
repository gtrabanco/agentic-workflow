...
| `loop-review-fold` | Poseer el enrutamiento simple review/fold: elegir review o fold según la evidencia persistida, volver a revisar solo HEADs cambiados y llevar los hallazgos no resueltos a `triage-issue --prioritize-now` para replan o ejecución manual de fases. Nunca fusionar ni descartar hallazgos silenciosamente. |
