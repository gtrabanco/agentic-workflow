...
export const RECOMMENDED_PROFILES: Readonly<Record<string, RecommendedProfile>> = {
  nan: {
    ...
    commands: {
      "audit-pr": { model: ["nan/mimo-v2.5", "nan/deepseek-v4-flash"], thinking: "high" },
      "product-audit": { model: ["nan/glm5.3", "nan/mimo-v2.5", "nan/deepseek-v4-flash"], thinking: "high" },
      "review-change": { model: ["nan/mimo-v2.5", "nan/glm5.3-flash", "nan/deepseek-v4-flash"], thinking: "high" },
      "unit-lane": { model: ["nan/mimo-v2.5", "nan/glm5.3-flash", "nan/deepseek-v4-flash"], thinking: "high" },
