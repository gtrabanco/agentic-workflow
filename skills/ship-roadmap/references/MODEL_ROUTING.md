...
| Final review/correction loop | opus/high | compose `loop-review-fold`; it invokes context-clean review and severity-routed fold workers, max two correction cycles by default |
